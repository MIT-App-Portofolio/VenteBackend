...
namespace Server.Pages.Admin
{
    public class CreateAffiliateModel : PageModel
    {
        ...
        public CreateAffiliateModel(UserManager<ApplicationUser> userManager, ApplicationDbContext context)
        {
        ...
        [BindProperty]
        public AffiliateCreate Input { get; set; }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            return RedirectToPage("/Admin/ManageAffiliates");
        }
    }
}
